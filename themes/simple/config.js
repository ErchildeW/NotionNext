const CONFIG = {
  ...
  SIMPLE_LOGO_DESCRIPTION: process.env.NEXT_PUBLIC_THEME_SIMPLE_LOGO_DESCRIPTION || '<div>Chinese Snus/Nicotine Pouch Supplier<br/>OEM Processing Support<br/>Seller and Flavor Review Blogger</div>',
